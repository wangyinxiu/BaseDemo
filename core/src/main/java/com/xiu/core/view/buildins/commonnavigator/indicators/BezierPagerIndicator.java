package com.xiu.core.view.buildins.commonnavigator.indicators;
...
import com.xiu.core.view.FragmentContainerHelper;
import com.xiu.core.view.buildins.ArgbEvaluatorHolder;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = UIUtil.getInstance().dp2px(3.5f);
        mMinCircleRadius = UIUtil.getInstance().dp2px(2);
        mYOffset = UIUtil.getInstance().dp2px(1.5f);
    }
